...
public partial class GameEntity {
    ...
    public Thronefall.Common.ViewPrefab viewPrefab { get { return (Thronefall.Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public Thronefall.Infrastructure.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Thronefall.Infrastructure.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Thronefall.Common.ViewPrefab)CreateComponent(index, typeof(Thronefall.Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(Thronefall.Infrastructure.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Thronefall.Common.ViewPrefab)CreateComponent(index, typeof(Thronefall.Common.ViewPrefab));
        component.Value = newValue;
